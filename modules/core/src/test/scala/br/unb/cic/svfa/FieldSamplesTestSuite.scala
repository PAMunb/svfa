...
class FieldSampleTest(var className: String = "", var mainMethod: String = "")
    extends JSVFATest {
...
class FieldSamplesTestSuite extends FunSuite with BeforeAndAfter {
  test(
    "in the class FieldSample01 we should detect 1 conflict in a direct sink of a tainted field"
  ) {
  ...
  ignore(
    "in the class FieldSample02 we should not detect any conflict because the tainted field was override"
  ) {
  ...
  test(
    "in the class FieldSample03 we should detect 1 conflict in a direct sink of a tainted field of a " +
      "contained object"
  ) {
  ...
  ignore(
    "in the class FieldSample04 we should not detect any conflict because the contained tainted object " +
  ...
  ignore(
    "in the class FieldSample05 we should detect 1 conflict in a direct sink of a object with a tainted field"
  ) {
  ...
  ignore(
    "in the class FieldSample06 we should not detect any conflict because the contained tainted object " +
      "and the tainted field was override"
  ) {
  ...
  ignore(
    "in the class FieldSample07 we should detect 1 conflict in a direct sink of a object with a tainted field"
  ) {
  ...
  ignore(
    "in the class FieldSample08 we should not detect any conflict because the contained tainted object " +
      "and the tainted field was override"
  ) {
  ...
  ignore(
    "in the class FieldSample09 we should not detect any conflict because the contained tainted object " +
      "and the tainted field was override"
  ) {
  ...
  ignore(
    "in the class FieldSample10 we should detect 1 conflict in a direct sink of a tainted field"
  ) {
  ...
  ignore(
    "in the class FieldSample11 we should not detect any conflict because the tainted field was override"
  ) {
  ...
  ignore(
    "in the class FieldSample12 we should detect 1 conflict in a direct sink of a tainted field of a " +
      "contained object"
  ) {
  ...
  // LIMITATION: Field overwrite is not supported
  ignore(
    "in the class FieldSample13 we should not detect any conflict because the contained tainted object " +
      "and the tainted field was override"
  ) {
  ...
  // are not detected by the Spark
  ignore(
    "in the class FieldSample14 we should detect 1 conflict in a direct sink of a object with a tainted field"
  ) {
  ...
  // LIMITATION: The Spark not support field sensitive analysis with context sensitivity
  ignore(
    "in the class FieldSample15 we should not detect any conflict because the contained tainted object " +
      "and the tainted field was override"
  ) {
