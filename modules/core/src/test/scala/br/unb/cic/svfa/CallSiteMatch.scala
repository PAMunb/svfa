...
class CallSiteMatch(var className: String = "", var mainMethod: String = "")
    extends JSVFATest {
...
class CallSiteMatchTestSuite extends FunSuite {
  test(
    "in the class CallSiteMatch1 we should detect 1 conflict of a unopened callsite test case"
  ) {
  ...
  test(
    "in the class CallSiteMatch2 we should detect 1 conflict of a unclosed callsite test case"
  ) {
  ...
  test(
    "in the class CallSiteMatch3 we should detect 1 conflict of a unclosed and unopened " +
      "callsite test case"
  ) {
  ...
  ignore(
    "in the class CallSiteMatch4 we should detect 2 conflict of a unclosed and unopened " +
  ...
  test(
    "in the class CallSiteMatch5 we should detect 2 conflict of a balanced callsite test case"
  ) {
