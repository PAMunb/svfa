...
class TestSuite extends FunSuite with BeforeAndAfter {
  ...
  ignore(
    "we should correctly compute the number of nodes and edges in the BlackBoardTest sample"
  ) {
  ...
  ignore(
    "we should correctly compute the number of nodes and edges of the CC16Test sample"
  ) {
  ...
  ignore(
    "we should correctly compute the number of nodes and edges of the IfElseTest sample"
  ) {
  ...
  ignore(
    "we should correctly compute the number of edges of the IfElseTest sample"
  ) {
    val svfa = new IfElseTest()
    svfa.buildSparseValueFlowGraph()
  ...
  test(
    "we should find exactly one conflict in this analysis of the IfElseTest sample"
  ) {
    val svfa = new IfElseTest()
    svfa.buildSparseValueFlowGraph()
    assert(svfa.reportConflictsSVG().size == 1)
  ...
  test(
    "we should find exactly one conflict in the InitStringBufferTest analysis"
  ) {
  ...
  ignore(
    "we should find exactly one conflict in the StringConcatTest analysis"
  ) {
...
//  }
  ...
  test(
    "we should find exactly one conflict in the StringToStringTest analysis"
  ) {
  ...
  test(
    "we should find exactly one conflict in the ContextSensitiveSample  analysis"
  ) {
  ...
  test("we should find exactly one conflict in the FieldSample analysis") {
    ...
    svfa.buildSparseValueFlowGraph()
    assert(
      svfa.reportConflictsSVG().size == 2
    ) // NOTE: We are not traversing the body of
  ...
  ignore(
    "we should find exactly one conflict in the MethodFieldTest analysis"
  ) {
