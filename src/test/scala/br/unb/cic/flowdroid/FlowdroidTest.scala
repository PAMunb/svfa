...
class FlowdroidTest(var className: String = "", var mainMethod: String = "") extends FlowdroidSpec {
...
class FlowdroidTestSuite extends FunSuite {
  ...
  test("in the class Aliasing4 we should detect 2 conflict") {
    val svfa = new FlowdroidTest("securibench.micro.aliasing.Aliasing4", "doGet")
    svfa.buildSparseValueFlowGraph()
  ...
  test("in the class Basic37 we should detect 1 conflict in a StringTokenizer test case") {
    val svfa = new FlowdroidTest("securibench.micro.basic.Basic37", "doGet")
    svfa.buildSparseValueFlowGraph()
    assert(svfa.reportConflictsSVG().size == 1)
  }
  ...
  test("in the class Basic41 we should detect 1 conflict in a use getInitParameter instead test case") {
    val svfa = new FlowdroidTest("securibench.micro.basic.Basic41", "doGet")
    svfa.buildSparseValueFlowGraph()
    assert(svfa.reportConflictsSVG().size == 1)
  }
  ...
  test("description: Collection1") {
    val svfa = new FlowdroidTest("securibench.micro.collections.Collections1", "doGet")
    svfa.buildSparseValueFlowGraph()
    assert(svfa.reportConflictsSVG().size == 1)
  }
  ...
  ignore("description: Collection3") {
    val svfa = new FlowdroidTest("securibench.micro.collections.Collections3", "doGet")
    svfa.buildSparseValueFlowGraph()
    assert(svfa.reportConflictsSVG().size == 2)
  }

  ignore("description: Collection4") {
    val svfa = new FlowdroidTest("securibench.micro.collections.Collections4", "doGet")
    svfa.buildSparseValueFlowGraph()
    assert(svfa.reportConflictsSVG().size == 1)
  }

  ignore("description: Collection5") {
    val svfa = new FlowdroidTest("securibench.micro.collections.Collections5", "doGet")
    svfa.buildSparseValueFlowGraph()
    assert(svfa.reportConflictsSVG().size == 1)
  }

  ignore("description: Collection6") {
    val svfa = new FlowdroidTest("securibench.micro.collections.Collections6", "doGet")
    svfa.buildSparseValueFlowGraph()
    assert(svfa.reportConflictsSVG().size == 1)
  }

  ignore("description: Collection7") {
    val svfa = new FlowdroidTest("securibench.micro.collections.Collections7", "doGet")
    svfa.buildSparseValueFlowGraph()
    assert(svfa.reportConflictsSVG().size == 1)
  }

  ignore("description: Collection8") {
    val svfa = new FlowdroidTest("securibench.micro.collections.Collections8", "doGet")
    svfa.buildSparseValueFlowGraph()
    assert(svfa.reportConflictsSVG().size == 1)
  }
  ...
  ignore("description: Collection10") {
    val svfa = new FlowdroidTest("securibench.micro.collections.Collections10", "doGet")
    svfa.buildSparseValueFlowGraph()
    assert(svfa.reportConflictsSVG().size == 1)
  }
  ...
  ignore("description: Collection12") {
    val svfa = new FlowdroidTest("securibench.micro.collections.Collections12", "doGet")
    svfa.buildSparseValueFlowGraph()
    assert(svfa.reportConflictsSVG().size == 1)
  }

  ignore("description: Collection13") {
    val svfa = new FlowdroidTest("securibench.micro.collections.Collections13", "doGet")
    svfa.buildSparseValueFlowGraph()
    assert(svfa.reportConflictsSVG().size == 1)
  }
  ...
  test("description: DataStructure1") {
    val svfa = new FlowdroidTest("securibench.micro.datastructures.Datastructures1", "doGet")
    svfa.buildSparseValueFlowGraph()
    assert(svfa.reportConflictsSVG().size == 1)
  }
  ...
  test("description: DataStructure3") {
    val svfa = new FlowdroidTest("securibench.micro.datastructures.Datastructures3", "doGet")
    svfa.buildSparseValueFlowGraph()
    assert(svfa.reportConflictsSVG().size == 1)
  }
  ...
  test("description: DataStructure6") {
    val svfa = new FlowdroidTest("securibench.micro.datastructures.Datastructures6", "doGet")
    svfa.buildSparseValueFlowGraph()
    assert(svfa.reportConflictsSVG().size == 1)
  }
  ...
  test("description: Factory1") {
    val svfa = new FlowdroidTest("securibench.micro.factories.Factories1", "doGet")
    svfa.buildSparseValueFlowGraph()
    assert(svfa.reportConflictsSVG().size == 1)
  }

  test("description: Factory2") {
    val svfa = new FlowdroidTest("securibench.micro.factories.Factories2", "doGet")
    svfa.buildSparseValueFlowGraph()
    assert(svfa.reportConflictsSVG().size == 1)
  }

  ignore("description: Factory3") {
    val svfa = new FlowdroidTest("securibench.micro.factories.Factories3", "doGet")
    svfa.buildSparseValueFlowGraph()
    assert(svfa.reportConflictsSVG().size == 1)
  }
  ...
  test("description: Inter2") {
    val svfa = new FlowdroidTest("securibench.micro.inter.Inter2", "doGet")
    svfa.buildSparseValueFlowGraph()
    assert(svfa.reportConflictsSVG().size == 2)
  }

  test("description: Inter3") {
    val svfa = new FlowdroidTest("securibench.micro.inter.Inter3", "doGet")
    svfa.buildSparseValueFlowGraph()
    assert(svfa.reportConflictsSVG().size == 1)
  }
...
//    println(svfa.svgToDotModel())
  ...
  ignore("description: Inter6") {
    val svfa = new FlowdroidTest("securibench.micro.inter.Inter6", "doGet")
    svfa.buildSparseValueFlowGraph()
    assert(svfa.reportConflictsSVG().size == 1)
  }
  ...
  test("description: Inter8") {
    val svfa = new FlowdroidTest("securibench.micro.inter.Inter8", "doGet")
    svfa.buildSparseValueFlowGraph()
    assert(svfa.reportConflictsSVG().size == 1)
  }

  ignore("description: Inter9") {
    val svfa = new FlowdroidTest("securibench.micro.inter.Inter9", "doGet")
    svfa.buildSparseValueFlowGraph()
    assert(svfa.reportConflictsSVG().size == 2)
  }

  test("description: Inter10") {
    val svfa = new FlowdroidTest("securibench.micro.inter.Inter10", "doGet")
    svfa.buildSparseValueFlowGraph()
    assert(svfa.reportConflictsSVG().size == 1)
  }
...
//  FLAKY
  ...
  test("description: Inter13") {
    val svfa = new FlowdroidTest("securibench.micro.inter.Inter13", "doGet")
    svfa.buildSparseValueFlowGraph()
    assert(svfa.reportConflictsSVG().size == 1)
  }
  ...
  test("description: Inter14") {
    val svfa = new FlowdroidTest("securibench.micro.inter.Inter14", "doGet")
    svfa.buildSparseValueFlowGraph()
    assert(svfa.reportConflictsSVG().size == 1)
  }
  ...
  ignore("description: Session1") {
    val svfa = new FlowdroidTest("securibench.micro.session.Session1", "doGet")
    svfa.buildSparseValueFlowGraph()
    assert(svfa.reportConflictsSVG().size == 1)
  }

  ignore("description: Session2") {
    val svfa = new FlowdroidTest("securibench.micro.session.Session2", "doGet")
    svfa.buildSparseValueFlowGraph()
    assert(svfa.reportConflictsSVG().size == 1)
  }

  ignore("description: Session3") {
    val svfa = new FlowdroidTest("securibench.micro.session.Session3", "doGet")
    svfa.buildSparseValueFlowGraph()
    assert(svfa.reportConflictsSVG().size == 1)
  }
  ...
  test("description: StrongUpdate1") {
    val svfa = new FlowdroidTest("securibench.micro.strong_updates.StrongUpdates1", "doGet")
    svfa.buildSparseValueFlowGraph()
    assert(svfa.reportConflictsSVG().size == 0)
  }

  test("description: StrongUpdate2") {
    val svfa = new FlowdroidTest("securibench.micro.strong_updates.StrongUpdates2", "doGet")
    svfa.buildSparseValueFlowGraph()
    assert(svfa.reportConflictsSVG().size == 0)
  }
