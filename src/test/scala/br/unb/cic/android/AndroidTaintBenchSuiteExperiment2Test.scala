 ...
 */
  ...
  test("in the APK overlaylocker2_android_samp, we should detect 7 flows") {
    ...
    val svfa = new AndroidTaintBenchTest(nameAPK) with Overlaylocker2AndroidSampSpec
    svfa.buildSparseValueFlowGraph()
  ...
  test("in the APK smssend_packageInstaller, we should detect 5 flows") {
    ...
    val svfa = new AndroidTaintBenchTest(nameAPK) with SmssendPackageInstallerSpec
    svfa.buildSparseValueFlowGraph()
  ...
  test("in the APK smsstealer_kysn_assassincreed_android_samp, we should detect 5 flows") {
    ...
    val svfa = new AndroidTaintBenchTest(nameAPK) with SmsstealerKysnAssassincreedAndroidSampSpec
    svfa.buildSparseValueFlowGraph()
  ...
  test("in the APK stels_flashplayer_android_update, we should detect 3 flows") {
    ...
    val svfa = new AndroidTaintBenchTest(nameAPK) with StelsFlashplayerAndroidUpdateSpec
    svfa.buildSparseValueFlowGraph()
